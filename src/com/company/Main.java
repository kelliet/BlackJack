...
//    private static void printDealerHand(ArrayList<Card> hand, boolean opening) {
    public static void printDealerHand(ArrayList<Card> hand, boolean opening, StringBuffer str) {

    System.out.print("Dealer: ");
    str.append("Dealer: ");
        if(opening) {
            System.out.printf("[%s%s][XX]", hand.get(0).getSuitStringShort(), hand.get(0).getRankStringShort());
            str.append(hand.get(0).getSuitStringShort()+ hand.get(0).getRankStringShort());
...
//    private static void printPlayerHand(ArrayList<Card> hand) {
    public static void printPlayerHand(ArrayList<Card> hand, StringBuffer str) {
...
//    private static void printResults(int dealerTotal, int playerTotal) {
    public static void printResults(int dealerTotal, int playerTotal, StringBuffer str) {
        if(playerTotal > dealerTotal) {
            System.out.println("Player Wins");
            str.append("Player Wins");
        } else if(playerTotal < dealerTotal) {
            System.out.println("Dealer Wins");
            str.append("Dealer Wins");
        } else if(playerTotal == dealerTotal) {
